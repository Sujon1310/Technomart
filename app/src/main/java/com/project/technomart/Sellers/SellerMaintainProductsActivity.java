...
public class SellerMaintainProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productsRef = FirebaseDatabase.getInstance().getReference().child("Seller Products").child(productID);

        applyChangesBtn = findViewById(R.id.seller_apply_changes_btn);
        deleteBtn = findViewById(R.id.seller_delete_product_btn);
            ...
            productsRef.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task)
                {
                    if (task.isSuccessful())
                    {
                        ...
                        Intent intent = new Intent(SellerMaintainProductsActivity.this, SellerProductsActivity.class);
                        startActivity(intent);
                        finish();
                    }
                }
