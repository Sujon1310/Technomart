...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    protected void onStart()
    {
        ...
        if (check.equals("settings"))
        {
            ...
            titleQuestions.setText("Please set Answers for the followings questions!");
    ...
    private void verifyUser()
    {
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot)
                {
                    if(dataSnapshot.exists())
                    {
                        ...
                        {
                            Toast.makeText(ResetPasswordActivity.this, "You did not set security questions. please Contact to the customer care.", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        {
            Toast.makeText(this, "Please set answer.", Toast.LENGTH_SHORT).show();
        }
    ...
    private void setAnswers()
    {
        ...
        {
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Users").child(PrevalentUser.currentOnlineUser.getPhone());
            ...
            reference.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task)
                {
                    if(task.isSuccessful())
                    {
                        Toast.makeText(ResetPasswordActivity.this, "You have successfully set Security Questions!", Toast.LENGTH_SHORT).show();
