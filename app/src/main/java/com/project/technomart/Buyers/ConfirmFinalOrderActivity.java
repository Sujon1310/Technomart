...
public class ConfirmFinalOrderActivity extends AppCompatActivity {
    ...
    private void ConfirmOrder()
    {
        ...
        //Creating New Entity Called Order
        final DatabaseReference ordersRef = FirebaseDatabase.getInstance().getReference().child("Orders").child(PrevalentUser.currentOnlineUser.getPhone());
            ...
            public void onComplete(@NonNull Task<Void> task)
            {
                if (task.isSuccessful())
                {
                    FirebaseDatabase.getInstance().getReference().child("Cart List").child("User View")
                            .child(PrevalentUser.currentOnlineUser.getPhone()).removeValue()
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task)
                                {
                                    if (task.isSuccessful())
                                    {
                                        ...
                                        //User Can not come to this activity.
